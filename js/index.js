...
function guardarNotaANotesTotals (nomNotesTotals) {
    for(let i = 0; i < nomNotesTotals.length; i++) {
           addCerca(nomNotesTotals[i], sostingut)
...
function cercador () {
    imgNotes.push("../notesimg/nota1.png");
    imgNotes.push("../notesimg/nota1sust.png");
    imgNotes.push("../notesimg/nota2.png");
    imgNotes.push("../notesimg/nota2sust.png");
    imgNotes.push("../notesimg/pentagrama.png");
}
